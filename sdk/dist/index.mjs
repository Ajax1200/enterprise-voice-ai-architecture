/**
 * @panthm/voice-client - ESM Module
...
export class PanthmVoiceClient extends EventEmitter {
  constructor(config = {}) {
    super();
    this.config = {
  ...
  async connect() {
    ...
    try {
      ...
      // Simulate real-time streaming ping to report sustained sub-500ms latency metrics
...
export async function createVoiceSession(config = {}) {
